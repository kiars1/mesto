...
const editAvatarPopup = new PopupWithForm ({
  ...
  submitCallback: (data) => {
    ...
    api.pushUserAvatar({avatar})
      ...
      .catch(() => {
        alert('Невозможно обновить аватар пользователя.'); //Потому что ошубку надо видеть, лучше конечно сделать отдельный popup... Но можно? Ругаться не будите?
      })
      .finally(() => {
        loading(false);
  })
...
const editProfilePopup = new PopupWithForm ({
  ...
  submitCallback: (data) => {
    ...
    .catch(() => {
      alert('Невозможно обновить данные пользователя.');//Потому что ошубку надо видеть, лучше конечно сделать отдельный popup... Но можно? Ругаться не будите?
    })
    .finally(() => {
      loading(false);
    })
...
const addCardPopup = new PopupWithForm ({
  ...
  submitCallback: (item) => {
    ...
    api.pushCards({name, link})
      ...
      .catch(() => {
        alert('Невозможно добавить новую карточку.'); //Потому что ошубку надо видеть, лучше конечно сделать отдельный popup... Но можно? Ругаться не будите?
      })
  }
}, keyClose);
